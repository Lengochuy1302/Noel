...
function onEmailInput(e) {
	...
	if(curEmailIndex > 0) {
		...
		if(value.toLowerCase().includes("thanh loan")) {
			...
			render_question.innerHTML= "Nhập đúng tên để trả lời câu hỏi"
